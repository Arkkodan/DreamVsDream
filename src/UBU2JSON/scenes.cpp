...
ubu::Scene::Scene(const std::string &file) : UBU(file), imageIndex(0) {}
...
ubu::Intro::Intro(const std::string &file) : Scene(file) {}
...
ubu::Title::Title(const std::string &file) : Scene(file), themeIndex(0) {}
...
ubu::Options::Options(const std::string &file) : Scene(file), themeIndex(0) {}
...
ubu::Fight::Fight(const std::string &file) : Scene(file) {}
...
ubu::Netplay::Netplay(const std::string &file) : Scene(file) {}
...
ubu::Credits::Credits(const std::string &file) : Scene(file) {}
