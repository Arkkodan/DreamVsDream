...
util::Vector::Vector(const Vector& other) :
	x(other.x), y(other.y)
{}

util::Vector::Vector(Vector&& other) noexcept :
	x(other.x), y(other.y)
{}
...
util::Vector::Vector(int x, int y) :
	x(x), y(y)
{}
...
util::Vectorf::Vectorf() :
	x(0.0), y(0.0)
{}

util::Vectorf::Vectorf(const Vectorf& other) :
	x(other.x), y(other.y)
{}

util::Vectorf::Vectorf(Vectorf&& other) noexcept :
	x(other.x), y(other.y)
{}
...
util::Vectorf::Vectorf(float x, float y) :
	x(x), y(y)
{}
